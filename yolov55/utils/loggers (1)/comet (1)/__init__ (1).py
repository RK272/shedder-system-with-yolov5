...
try:
    ...
    COMET_PROJECT_NAME = config.get_string(os.getenv('COMET_PROJECT_NAME'), 'comet.project_name', default='yolov55')
...
COMET_MODEL_NAME = os.getenv('COMET_MODEL_NAME', 'yolov55')
...
class CometLogger:
    ...
    def upload_dataset_artifact(self):
        dataset_name = self.data_dict.get('dataset_name', 'yolov55-dataset')
