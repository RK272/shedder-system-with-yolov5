...
# Model
model = torch.hub.load("ultralytics/yolov55", "yolov5s")  # or yolov5n - yolov5x6, custom
...
model = torch.hub.load(
    "ultralytics/yolov55", "custom", "yolov5m-seg.pt"
...
```python
model = torch.hub.load(
    "ultralytics/yolov55", "custom", "yolov5s-cls.pt"
